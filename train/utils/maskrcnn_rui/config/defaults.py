...
_C.INPUT.W_SIZE_TRAIN = 1333
_C.INPUT.H_SIZE_TRAIN = 1333
_C.INPUT.W_SIZE_TEST = 1333
_C.INPUT.H_SIZE_TEST = 1333
...
_C.DATA = CN()
_C.DATA.IF_RGB_AUG = True
_C.DATA.IF_CLIP_DISPIN_GTMAX = False
_C.DATA.CLIP_DISPIN = 0.
_C.DATA.TRAIN_AUG = 'RAND_CROP'
_C.DATA.VAL_AUG = 'NONE'
_C.DATA.SEQ = CN()
_C.DATA.SEQ.IF_SUBSAMPLE = False
_C.DATA.SEQ.IF_SUBSAMPLE_RATIO = False
_C.DATA.SEQ.SUB_SAMPLE_RATIO = 1.0
_C.DATA.IF_VAL_DIST = True
# _C.DATA.SEQ.CLIP_N_IN_MASKRCNN = False
# _C.DATA.SEQ.COCO_SUBSET = "coco_scale_eccv"

_C.DATA.INET = CN()
_C.DATA.INET.FIXED_LABEL = False

_C.TRAINING = CN()
_C.TRAINING.NUM_VAL_SUMMARY = 8
_C.TRAINING.TIMING = False
_C.TRAINING.MAX_CKPT = 10

_C.MODEL.MULTI_SCALE_PRED = CN()
_C.MODEL.MULTI_SCALE_PRED.FEED_PRED_BACK = True

_C.MODEL.MODE = CN()
_C.MODEL.MODE.NO_CONF = True
_C.MODEL.MODE.WITH_IM1 = False
# _C.MODEL.MODE.MULTI_D = False
# _C.MODEL.MODE.SEG_ONLY = False
_C.MODEL.EST_DISP = True
_C.MODEL.EST_SEG = False
_C.MODEL.CASCADE = False

_C.MODEL.CLS_CHANNELS = 41
_C.MODEL.USE_PPM = False

_C.MODEL.loss = CN()
_C.MODEL.loss.smooth_loss_weight = 0.       # Smoothness loss weight
_C.MODEL.loss.long_range_smooth_loss_weight = 0.       # Smoothness loss weight
_C.MODEL.loss.ssim_loss_weight = 0.       # SSIM loss weight in photometric consistency loss
_C.MODEL.loss.disp_consistency_loss_weight = 0.
